const data = {
  ...
  ru: {
    translation: {
      home: {
        wel_text: `Helmchron — семейная компания, предоставляющая комплексные инженерные решения с полным спектром услуг для производственных предприятий фармацевтической, химической, пищевой и биопродукции, электроники, энергетики, а также нефти и газа. Мы гордимся тем, что с 2010 года вносим свой вклад в производство доступной, безопасной и высококачественной продукции по всему миру.
        Наша миссия осталась прежней с самого начала – мы улучшаем качество жизни для всех людей во всем мире, сохраняя при этом окружающую среду здоровой для будущих поколений.
        Сегодня наша сфера деятельности шире, а наша команда более разнообразна, обеспечивая уникальные перспективы, гибкость и эффективность.
        Наши инженерные решения теперь предоставляются лидерам и новаторам в различных отраслях с упором на глобальное влияние, устойчивые результаты и долгосрочное партнерство.`
      }
    }
  }
};
